...
(function($, window, document) {
  ...
  */
  ...
  EmojiArea.createIcon = function(emoji, menu) {
    ...
    var column = emoji[2];
    var name = emoji[3];
    var filename = '/lib/img/' + 'emoji_spritesheet_!.png';
    var blankGifPath = '/lib/img/' + 'blank.gif';
    var iconSize = menu && Config.Mobile ? 16 : $.emojiarea.iconSize;
    ...
    style += 'background:url(' + 'js/' + filename.replace('!', category) + ') '
        + xoffset + 'px ' + yoffset + 'px no-repeat;';
    style += 'background-size:' + scaledWidth + 'px ' + scaledHeight
        + 'px;';
    return '<img src="'+ 'js/' + blankGifPath + '" class="img" style="'
